...
class perceptron(object):
    ...
    def train(self, X, y, X_test, y_test, beta, n_particulas, max_iter, i):
        ...
        print(">> Training nn with QDPSO and different swarms by layers")
        self.X = X
        ...
        self.param[self.d_hidden:] = result_output['param_o']
        self.param[:self.d_hidden] = result_hidden['param_h']
