...
from nn.swarm_perceptron_qpso_concurrencia import perceptron 
...
def main(data_name, training_type, algorithm, max_iter_pass, n_particulas_pass):
    ...
    for i in range(n_training):
        ...
        gBest.append(nn.train(X_train, y_train, X_test, y_test, beta, n_particulas, max_iter))
...
if __name__ == '__main__':
    datasets = ["iris", "wine"] #["iris", "wine", "circle", "breast"]
    training_type = 'training_exchange_layers'
    algorithm = 'qdpso'
    
    iterations_list = [20, 40, 60, 80, 100, 500] # [20, 40, 60, 80, 100, 500, 1000]
