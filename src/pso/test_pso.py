...
#print('shape of plotting: ', np.array(nn.metric_loss)[0].shape)
...
for i in range(1000):
    y_plot.append(nn.metric_loss[i][0])

fig1, ax1 = plt.subplots()
ax1.plot(x_plot, y_plot)
ax1.set_xlabel('epoch')
ax1.set_ylabel('loss')
ax1.set_title("The evolution of the loss during the trainning with PSO")
